package com.example.democalculator3;
...
public class MainActivity extends AppCompatActivity {
    EditText txtAnswer;
    Button btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btn0, btnStop, btnSqr;
    Button btnAdd, btnSubt, btnMult, btnEquals, btnSin, btnCos, btnTan, btnCe, btnC, btnDiv, btnPerc, btnLog, btnExp;
    Double Answer;
    Double Val2 = 0.0;
    Double Val1 = 0.1;
    String Sign;
